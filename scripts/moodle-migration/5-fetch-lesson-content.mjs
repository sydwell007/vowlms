...
const ACADEMIES = [
  { id: "upskilling",      base: process.env.UPSKILLING_MOODLE_BASE_URL || "https://goalvow.com/upskilling", token: requireMoodleToken("upskilling"), vowSlug: "upskilling-academy", name: "Upskilling Academy" },
  { id: "skills-training", base: process.env.SKILLS_TRAINING_MOODLE_BASE_URL || "https://goalvow.com/skillstraining", token: requireMoodleToken("skills-training"), vowSlug: "skills-training-academy", name: "Skills Training" },
  { id: "chef-academy",    base: process.env.CHEF_ACADEMY_MOODLE_BASE_URL || "https://goalvow.com/chefacademy", token: requireMoodleToken("chef-academy"), vowSlug: "chef-academy", name: "Chef Academy" },
  { id: "schools",         base: process.env.GOALVOW_SCHOOLS_MOODLE_BASE_URL || "https://goalvow.com/schools", token: requireMoodleToken("schools"), vowSlug: "private-school", name: "GoalVow Schools" },
  { id: "business-school", base: process.env.BUSINESS_SCHOOL_MOODLE_BASE_URL || "https://goalvow.com/businessschool", token: requireMoodleToken("business-school"), vowSlug: "business-school", name: "Business School" },
  { id: "university",      base: process.env.GOALVOW_UNIVERSITY_MOODLE_BASE_URL || "https://goalvow.com/university", token: requireMoodleToken("university"), vowSlug: "university-online", name: "University Online" },
];
