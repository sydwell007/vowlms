...
const contentSecurityPolicy = [
  ...
  "font-src 'self' data:",
  "img-src 'self' data: blob: https://api.goalvow.com https://*.google-analytics.com https://www.googletagmanager.com",
  "media-src 'self' blob: https://api.goalvow.com https://goalvow.com",
  "connect-src 'self' https://api.goalvow.com https://vowhumans.com https://*.google-analytics.com https://*.analytics.google.com https://www.googletagmanager.com",
