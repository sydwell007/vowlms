        ...
        {tile.roles.map((role) => {
          ...
          return (
            <button
              ...
              className="premium-card interactive-lift flex flex-col items-start rounded-lg border-l-4 p-5 text-left text-ink focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1765a6]"
