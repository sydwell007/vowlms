...
const PROFILES: Record<string, ModuleZeroProfile> = {
  ...
  "microsoft-word-basics": { promise: "produce clear, accessible, and professionally formatted Word documents with confidence", challenge: "A client-facing report contains inconsistent formatting, difficult navigation, and accessibility issues shortly before publication.", reflection: "Which document-quality checks should happen before a professional file is shared?" },
  "microsoft-word-advance": { promise: "design secure, reusable, and automated Word workflows for complex professional documents", challenge: "A team recreates the same reports manually every month and introduces avoidable formatting and data errors.", reflection: "Which templates, automation, and protection controls would make this workflow more reliable?" },
  "microsoft-excel-basics": { promise: "organise, calculate, visualise, and communicate spreadsheet data accurately", challenge: "A monthly workbook is difficult to understand because its data, formulas, formatting, and charts are inconsistent.", reflection: "What makes a spreadsheet trustworthy and useful to another person?" },
  "microsoft-excel-advance": { promise: "analyse complex data with advanced formulas, validation, auditing, PivotTables, and automation", challenge: "Leaders need a reliable answer from several large datasets, but the workbook contains hidden errors and repeated manual steps.", reflection: "How would you make the analysis accurate, repeatable, and easy to audit?" },
  "microsoft-power-point": { promise: "build and deliver clear, compelling, and accessible presentations for real audiences", challenge: "An important proposal contains too much text, inconsistent visuals, and no clear story for decision-makers.", reflection: "What should an audience understand, feel, and do after your presentation?" },
  "microsoft-outlook": { promise: "manage email, calendars, contacts, tasks, and communication workflows with professional control", challenge: "Important messages, meeting actions, and deadlines are being lost across a crowded inbox and calendar.", reflection: "Which Outlook workflow would reduce friction without creating more administration?" },
  "microsoft-access": { promise: "design relational databases and turn structured records into useful queries, forms, and reports", challenge: "A growing organisation tracks related customer and service records in disconnected spreadsheets that produce conflicting answers.", reflection: "Which entities, relationships, and controls would make the data dependable?" },
};
