        ...
        <div className="premium-card rounded-2xl p-8">
          {sent ? (
            <div className="text-center space-y-4">
              ...
              <Link href="/auth/signin" className="block w-full rounded-lg bg-gold px-6 py-3 text-center text-sm font-semibold text-[#06111f] shadow-[0_10px_24px_rgba(245,197,66,0.25)] transition hover:bg-[#e8b830]">
                Back to sign in
              </Link>
            </div>
          ) : (
